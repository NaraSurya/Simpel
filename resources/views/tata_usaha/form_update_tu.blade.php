...
@include('include.error')
    <div class="container">
        <div class="form-row ">
            ...
            {{-- form tata usaha --}}
            <form id="form_tata_usaha" method="POST" action="/tu/biodata_tu/{{ $tu->id }}" enctype="multipart/form-data">
            @csrf
            @method('PUT');
                    ...
                    <div class="card-body">
                        <div class="form-group col ">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" class="form-control" name="nama" id="nama_gr" placeholder="Harap diisi" value="{{ $tu->nama }}">
                            </div>    
                        </div>
                        <div class="form-group col">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" class="form-control" name="alamat" id="alamat_gr" placeholder="Harap diisi" value="{{ $tu->alamat }}">
                            </div>
                        </div>
                        <div class="form-row ml-2 ">
                            ...
                            <label for="tgl_gr">Tanggal lahir</label>
                                    <div class="input-container">
                                        ...
                                        <input type="date" class="form-control" name="tgl_lahir" id="tgl_gr" placeholder="Harap diisi" value="{{ $tu->tgl_lahir }}">
                                    </div>
                            </div>
                            <div class="form-group col mr-3">
                                ...
                                <div class="input-container">
                                    ...
                                    <input type="text" class="form-control" name="no_hp" id="telepon_gr" placeholder="Harap diisi" value="{{ $tu->no_hp }}">
                                </div>  
                            </div>
                        </div>
                            ...
                            <div class="form-group col mr-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 pt-2" >  
                                            <input type="radio"  id="laki1" name="jenis_kelamin" value="Laki-Laki" {{ $tu->jenis_kelamin =='Laki-Laki'?'checked':'' }} required>
                                            <label  for="laki1">Laki-Laki</label>
                                        </div>
                                        <div class="col-md-4 pt-2" >  
                                            <input type="radio"  id="perempuan2" name="jenis_kelamin"  value="Perempuan" {{ $tu->jenis_kelamin =='Perempuan'?'checked':'' }} required>
                                ...
                                <div class="form-group col mr-3">
                                    <label for="email_gr">Email</label>
                                        <div class="input-container">
                                            ...
                                            <input type="email" class="form-control" name="email" id="email_gr" placeholder="Harap diisi" value="{{ $tu->email }}">
                                        </div>   
                                </div>
                        </div>
                            ...
                            <div class="form-row ml-2 ">   
                                <div class="form-group col mr-4">
                                    ...
                                    <div class="input-container">
                                        ...
                                        <option value="{{$pilihan->id}}" {{ $pilihan->id == $tu->agama_id ? 'selected' : ''}}>{{$pilihan->agama}}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                </div>
